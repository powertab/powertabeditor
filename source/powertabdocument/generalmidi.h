...
extern bool IsValidMidiChannel(uint8_t channel);
extern bool IsValidMidiChannelVolume(uint8_t volume);
extern bool IsValidMidiChannelEffectLevel(uint8_t level);

// MIDI Note Functions
extern bool IsValidMidiNote(uint8_t note);
extern bool IsValidMidiNoteKey(uint8_t key);
extern uint8_t GetMidiNotePitch(uint8_t note);
extern int32_t GetMidiNoteOctave(uint8_t note);
extern string GetMidiNoteText(uint8_t note, bool sharps);
extern uint8_t OffsetMidiNote(uint8_t note, int8_t offset);
extern bool IsValidMidiNoteVolume(uint8_t volume);

// MIDI Preset Functions
extern bool IsValidMidiPreset(uint8_t preset);

// MIDI Percussion Preset Functions
extern bool IsValidMidiPercussionPreset(uint8_t preset);
