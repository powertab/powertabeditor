...
const uint8_t         Guitar::DEFAULT_PRESET                 = MIDI_PRESET_ACOUSTIC_GUITAR_STEEL;
const uint8_t         Guitar::DEFAULT_INITIAL_VOLUME         = 104;
const uint8_t         Guitar::DEFAULT_PAN                    = PAN_CENTER;
const uint8_t         Guitar::DEFAULT_REVERB                 = MIN_MIDI_CHANNEL_EFFECT_LEVEL;
const uint8_t         Guitar::DEFAULT_CHORUS                 = MIN_MIDI_CHANNEL_EFFECT_LEVEL;
const uint8_t         Guitar::DEFAULT_TREMOLO                = MIN_MIDI_CHANNEL_EFFECT_LEVEL;
const uint8_t         Guitar::DEFAULT_PHASER                 = MIN_MIDI_CHANNEL_EFFECT_LEVEL;
const uint8_t         Guitar::DEFAULT_CAPO                   = 0;

const uint8_t         Guitar::MIN_PRESET                     = FIRST_MIDI_PRESET;
const uint8_t         Guitar::MAX_PRESET                     = LAST_MIDI_PRESET;

const uint8_t         Guitar::MIN_INITIAL_VOLUME             = MIN_MIDI_CHANNEL_VOLUME;
const uint8_t         Guitar::MAX_INITIAL_VOLUME             = MAX_MIDI_CHANNEL_VOLUME;
	
const uint8_t         Guitar::MIN_PAN                        = MIN_MIDI_CHANNEL_EFFECT_LEVEL;
const uint8_t         Guitar::MAX_PAN                        = MAX_MIDI_CHANNEL_EFFECT_LEVEL;
const uint8_t         Guitar::PAN_HARD_LEFT                  = MIN_PAN;
const uint8_t         Guitar::PAN_CENTER                     = 64;
const uint8_t         Guitar::PAN_HARD_RIGHT                 = MAX_PAN;

const uint8_t         Guitar::MIN_REVERB                     = MIN_MIDI_CHANNEL_EFFECT_LEVEL;             
const uint8_t         Guitar::MAX_REVERB                     = MAX_MIDI_CHANNEL_EFFECT_LEVEL;             

const uint8_t         Guitar::MIN_CHORUS                     = MIN_MIDI_CHANNEL_EFFECT_LEVEL;             
const uint8_t         Guitar::MAX_CHORUS                     = MAX_MIDI_CHANNEL_EFFECT_LEVEL;             

const uint8_t         Guitar::MIN_TREMOLO                    = MIN_MIDI_CHANNEL_EFFECT_LEVEL;            
const uint8_t         Guitar::MAX_TREMOLO                    = MAX_MIDI_CHANNEL_EFFECT_LEVEL;            

const uint8_t         Guitar::MIN_PHASER                     = MIN_MIDI_CHANNEL_EFFECT_LEVEL;            
const uint8_t         Guitar::MAX_PHASER                     = MAX_MIDI_CHANNEL_EFFECT_LEVEL;            
	...
	m_chorus(chorus), m_tremolo(tremolo), m_phaser(phaser), m_capo(capo)
{
	...
	assert(IsValidMidiPreset(preset));
	assert(IsValidMidiChannelVolume(initialVolume));
...
bool Guitar::Serialize(PowerTabOutputStream& stream)
{
	//------Last Checked------//
	// - Dec 8, 2004
	stream << m_number;
