...
template <typename T>
T SettingsManager::get(const std::string &key, const T &default_val) const
{
...
template <typename T>
std::vector<T> SettingsManager::getList(const std::string &key) const
{
...
template <typename T>
void SettingsManager::setList(const std::string &key,
