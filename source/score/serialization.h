...
#include "rapidjson/genericstream.h"
...
private:
    ...
    rapidjson::GenericReadStream myStream;
...
private:
    ...
    rapidjson::GenericWriteStream myWriteStream;
    rapidjson::PrettyWriter<rapidjson::GenericWriteStream> myStream;
