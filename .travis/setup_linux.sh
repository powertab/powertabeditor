...
sudo apt-get install -yqq cmake qt52base libboost1.55-dev libboost-date-time1.55-dev libboost-filesystem1.55-dev libboost-iostreams1.55-dev libboost-program-options1.55-dev libboost-regex1.55-dev libasound2-dev g++-4.8 binutils-dev
